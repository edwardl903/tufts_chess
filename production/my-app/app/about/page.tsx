  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="relative px-20 p-8 text-white">
      ...
      <section className="py-6 mb-14 px-80 bg-white">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div>
                <p className="font-mono text-lg text-justify text-gray-700">
      ...
      <section className="py-6 mb-14 px-80 bg-white">
        <div className="container text-gray-700 mx-auto grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            <div className="font-mono">
                <p className="text-2xl font-bold space-y-8">
      ...
      {/* <div className="absolute inset-0 bg-gray-700 opacity-50"></div> */}
        ...
        <section className="w-full bg-white flex justify-center items-center overflow-hidden block p-10 -mb-5">
